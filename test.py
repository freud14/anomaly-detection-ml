...
class Tester:
    ...
    def hyperspherical_predictor(self, gamma=0.5):
        ...
        hypersphere = HypersphericalPredictor(kernel='rbf', gamma=gamma)
    ...
    def one_class_svm(self, gamma=0.5):
        train_normal = self.normal[:self.nbTrain]
        test_normal = self.normal[self.nbTrain:self.nbTrain + self.nbTest]
        test_anormal = self.anomaly[:self.nbTest]
        ...
        one_class_svm = svm.OneClassSVM(nu=0.01, kernel='rbf', gamma=gamma)
    ...
    def multiclass_hyperspherical_predictor(self, gamma=0.5):
        ...
        multiclass_hypersphere = multiclass.OneVsRestClassifier(HypersphericalPredictor(kernel='rbf', gamma=gamma))
    ...
    def multiclass_one_class_svm(self, gamma=0.5):
        ...
        multiclass_oneclass = multiclass.OneVsRestClassifier(svm.OneClassSVM(nu=0.01, kernel='rbf', gamma=gamma))
